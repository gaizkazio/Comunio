...
Posee distintos mtodos pblicos y estticos (por lo tanto no se necesita un
objeto como tal para acceder a ellos) para la lectura de los tipos de datos bsicos
en Java. Adems, todos los mtodos tienen un control de errores mediante peticin
sucesiva de introduccin de dato hasta que estos sean correctos.
*/
public class Utilidades
{
  /**
  Permite introducir por teclado en la consola un nmero entero (32 bits = -2147483648 <-> 2147483648)
  ...
  */
	public static int leerEntero()
	{
      ...
      {
				System.out.println("No tecle un nmero entero-Repetir");
      }
			catch (Exception e)
			{
  ...
  /**
  Permite introducir por teclado en la consola un nmero real realizando
